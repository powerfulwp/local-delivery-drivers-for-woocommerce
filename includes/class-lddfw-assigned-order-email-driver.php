...
if ( ! class_exists( 'LDDFW_Assigned_Order_Email_Driver', false ) ) :
	...
	class LDDFW_Assigned_Order_Email_Driver extends WC_Email {
		...
		public function __construct() {
			...
			$this->title          = __( 'Assigned order - driver', 'woocommerce' );
			$this->description    = __( 'This is an order notification sent to the delivery driver containing that order has been assigned to him.', 'woocommerce' );
		...
		public function get_default_subject() {
			return __( 'A new order has been assigned to you!', 'woocommerce' );
		}
		...
		public function get_default_heading() {
			return __( 'Order Assigned', 'woocommerce' );
		}

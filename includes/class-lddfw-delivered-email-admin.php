...
if ( ! class_exists( 'LDDFW_Delivered_Email_Admin', false ) ) :
	...
	class LDDFW_Delivered_Email_Admin extends WC_Email {
		...
		public function __construct() {
			...
			$this->description    = __( 'This is an order notification sent to the administrator containing order details after an order has been marked as Delivered.', 'woocommerce' );
		...
		public function get_default_heading() {
			return __( 'Order Delivered', 'woocommerce' );
		}

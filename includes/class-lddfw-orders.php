...
class LDDFW_Orders {
	...
	public function lddfw_drivers_orders_dashboard_report_query() {
		...
		$query = $wpdb->get_results(
			$wpdb->prepare(
				"select pm.meta_value driver_id , post_status, u.display_name driver_name , count(*) as orders from {$wpdb->prefix}posts p
				...
				<div class="lddfw_box">
					<div class="row">
						<div class="col-12">
							...
							<a class="lddfw_order_number" href="' . esc_url( lddfw_drivers_page_url( 'lddfw_screen=order&lddfw_orderid=' . $orderid ) ) . '"><b>' . esc_html( __( 'Order #', 'lddfw' ) ) . $orderid . '</b></a>
							<a class="lddfw_order_address" href="' . esc_url( lddfw_drivers_page_url( 'lddfw_screen=order&lddfw_orderid=' . $orderid ) ) . '">' . $shippingaddress . '<br> ' . $shipping_city . ' ' . $shipping_state . '</a>
							<a class="lddfw_order_distance" href="' . esc_url( lddfw_drivers_page_url( 'lddfw_screen=order&lddfw_orderid=' . $orderid ) ) . '">' . esc_html( __( 'Distance: ', 'lddfw' ) ) . $distance . '</a>
							<div class="lddfw_handle_column"  style="display:none"><button  class="lddfw_sort-up btn btn-outline-secondary "><svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="chevron-up" class="svg-inline--fa fa-chevron-up fa-w-14" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="currentColor" d="M240.971 130.524l194.343 194.343c9.373 9.373 9.373 24.569 0 33.941l-22.667 22.667c-9.357 9.357-24.522 9.375-33.901.04L224 227.495 69.255 381.516c-9.379 9.335-24.544 9.317-33.901-.04l-22.667-22.667c-9.373-9.373-9.373-24.569 0-33.941L207.03 130.525c9.372-9.373 24.568-9.373 33.941-.001z"></path></svg></button><button class="btn btn-outline-secondary lddfw_sort-down">

				...
				<div class='lddfw_box'>
					<div class='row'>
						<div class='col-12'>
							...
							<a class='lddfw_order_number' href='" . home_url( '/lddfwapp/order/' ) . $orderid . "'><b>" . esc_html( __( 'Order #', 'lddfw' ) ) . "$orderid</b></a>
							<a class='lddfw_order_address' href='" . home_url( '/lddfwapp/order/' ) . $orderid . "'>$shippingaddress <br> $shipping_city $shipping_state</a>
							<a class='lddfw_order_distance' href='" . home_url( '/lddfwapp/order/' ) . $orderid . "'>" . esc_html( __( 'Distance', 'lddfw' ) ) . " $distance</a>
				...
				<div class='lddfw_box'>
					<div class='row'>
						<div class='col-12'>
							...
							<a class='lddfw_order_number line' href='" . home_url( '/lddfwapp/order/' ) . $orderid . "'><b>" . esc_html( __( 'Order #', 'lddfw' ) ) . "$orderid</b></a>
							<a class='lddfw_order_address line' href='" . home_url( '/lddfwapp/order/' ) . $orderid . "'>$shippingaddress <br> $shipping_city $shipping_state</a>";
								if ( '' !== $distance ) {
									$html .= '<a class=\'lddfw_order_distance lddfw_line\' href=\'' . home_url( '/lddfwapp/order/' ) . $orderid . '\'>' . esc_html( __( 'Distance', 'lddfw' ) ) . $distance . '</a>';
								}
								if ( '' !== $delivered_date ) {
									$html .= '<a class=\'lddfw_order_failed_date lddfw_line\' href=\'' . home_url( '/lddfwapp/order/' ) . $orderid . '\'>Failed Date : ' . date( $date_format . ' ' . $time_format, strtotime( $failed_date ) ) . '</a>';
								}
			...
			while ( $wc_query->have_posts() ) {
				...
				<div class='lddfw_box'>
					<div class='row'>
						<div class='col-12'>
							<span class='lddfw_counter'>$counter</span>
							<a class='lddfw_order_number lddfw_line' href='" . home_url( '/lddfwapp/order/' ) . $orderid . "'><b>" . esc_html( __( 'Order #', 'lddfw' ) ) . "$orderid</b></a>
							<a class='lddfw_order_address lddfw_line' href='" . home_url( '/lddfwapp/order/' ) . $orderid . "'>$shippingaddress <br> $shipping_city $shipping_state</a>";
							if ( '' !== $distance ){
								$html .= "<a class='lddfw_order_distance lddfw_line' href='" . home_url( '/lddfwapp/order/' ) . $orderid . "'>" . esc_html( __( 'Distance', 'lddfw' ) ) . " $distance</a>";
							}
							if ( '' !== $delivered_date  ){
								$html .= "<a class='lddfw_order_delivered_date lddfw_line' href='" . home_url( '/lddfwapp/order/' ) . $orderid . "'>" . esc_html( __( 'Delivered Date', 'lddfw' ) ) . " : " . date( $date_format . ' ' . $time_format, strtotime( $delivered_date ) ) . "</a>";
							}

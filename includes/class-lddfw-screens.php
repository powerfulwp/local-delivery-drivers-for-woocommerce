...
class LDDFW_Screens
{
    ...
    public function lddfw_header( $title = null, $back_url = null )
    {
        ...
        ;
        $html .= "<div class='col-2 text-right'>\r\n\t\t\t\t\t<a href='#' id='lddfw_menu' onclick='lddfw_openNav()'>\r\n\t\t\t\t\t<i class=\"fas fa-bars\"></i>\r\n\t\t\t\t\t{$availability_icon}\r\n\t\t\t\t\t</a>\r\n\t\t\t\t\t<div id='lddfw_mySidenav' class='lddfw_sidenav'>\r\n\t\t\t\t\t<a href='javascript:void(0)' class='lddfw_closebtn' onclick='lddfw_closeNav()'>&times;</a>\r\n\t\t\t\t\t\t\t<span class=\"dropdown-header\">\r\n\t\t\t\t\t\t\t\t<h3>" . $lddfw_user->first_name . ' ' . $lddfw_user->last_name . "</h3>\r\n\t\t\t\t\t\t\t</span>\r\n\t\t\t\t\t\t\t<div class=\"dropdown-divider\"></div>\r\n\t\t\t\t\t\t\t<a class=\"dropdown-item\" href='" . esc_url( get_site_url() ) . '/lddfwapp/' . "'><i class='fas fa-home'></i> " . esc_html( __( 'Dashboard', 'lddfw' ) ) . '</a>
							<div class="dropdown-divider"></div>';
        $html .= "\r\n\t\t\t\t\t\t\t<a class=\"dropdown-item\" href='" . esc_url( get_site_url() ) . '/lddfwapp/assign_to_driver' . "'><i class='fas fa-angle-double-right'></i> " . esc_html( __( 'Assign to driver', 'lddfw' ) ) . ' (' . $lddfw_assign_to_driver_counter . ")</a>\r\n\t\t\t\t\t\t\t<a class=\"dropdown-item\" href='" . esc_url( get_site_url() ) . '/lddfwapp/out_for_delivery' . "'><i class='fas fa-angle-double-right'></i> " . esc_html( __( 'Out for delivery', 'lddfw' ) ) . ' (' . $lddfw_out_for_delivery_counter . ")</a>\r\n\t\t\t\t\t\t\t<a class=\"dropdown-item\" href='" . esc_url( get_site_url() ) . '/lddfwapp/failed_delivery' . "'><i class='fas fa-angle-double-right'></i> " . esc_html( __( 'Failed delivery', 'lddfw' ) ) . ' (' . $lddfw_failed_attempt_counter . ")</a>\r\n\t\t\t\t\t\t\t<a class=\"dropdown-item\" href='" . esc_url( get_site_url() ) . '/lddfwapp/delivered' . "'><i class='fas fa-angle-double-right'></i> " . esc_html( __( 'Delivered', 'lddfw' ) ) . ' (' . $lddfw_delivered_counter . ')</a>
							';
        $html .= "<div class=\"dropdown-divider\"></div>\r\n\t\t\t\t\t\t\t<a class=\"dropdown-item\" title='" . esc_attr( __( 'Log out', 'lddfw' ) ) . "' href='" . esc_url( get_site_url() ) . '/lddfwapp/logout' . "'><i class='fas fa-sign-out-alt'></i> " . esc_html( __( 'Log out', 'lddfw' ) ) . '</a>
					</div>
					</div>
                </div>
            </div>
...
';
    ...
    public function lddfw_out_for_delivery_screen( $driver_id )
    {
        ...
        $back_url = get_site_url() . '/lddfwapp/dashboard';
    ...
    public function lddfw_order_screen( $driver_id )
    {
        ...
        switch ( 'wc-' . $order_status ) {
            case get_option( 'lddfw_delivered_status' ):
                $back_url = get_site_url() . '/lddfwapp/delivered';
                break;
            case get_option( 'lddfw_failed_attempt_status' ):
                $back_url = get_site_url() . '/lddfwapp/failed_delivery';
                break;
            case get_option( 'lddfw_out_for_delivery_status' ):
                $back_url = get_site_url() . '/lddfwapp/out_for_delivery';
                break;
        }

...
echo sprintf( esc_html__( 'Hi %s,', 'woocommerce' ), esc_html( $user_info->first_name ) ) . "\n\n";
/* translators: %s: Order number */
echo sprintf( esc_html__( 'Order #%s has been assigned to you.', 'woocommerce' ), esc_html( $order->get_order_number() ) ) . "\n\n";
